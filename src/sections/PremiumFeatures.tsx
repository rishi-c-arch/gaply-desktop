      ...
      <div className="premium2-inner">
        ...
        <div className="premium2-right">
          ...
          <div className="premium2-cards-row">
            {/*
              DOM order supports desktop grid (1024px+): left column = DM, Journal Verify, Deep Analysis;
              right column = PublishReady full height. On smaller screens, stack reads top-to-bottom.
            */}
            {/* DataMaestro – Module_02 */}
            <article className="premium2-card premium2-card--side premium2-card--dm">
            ...
            {/* Journal Verification – Module_03 */}
            <article className="premium2-card premium2-card--side premium2-card--compact premium2-card--jv">
              <div className="premium2-card-header">
                <span className="premium2-chip premium2-chip--light">Module_03</span>
                <span className="material-symbols-outlined premium2-card-icon">fact_check</span>
              </div>
              <h3 className="premium2-card-title">Journal Verification</h3>
              <p className="premium2-card-body">
                Verify journal fit. AI-powered matching to find the best venue for your manuscript.
              </p>
              <div className="premium2-card-footer">
                <div className="premium2-avatar-row">
                  <span className="premium2-avatar premium2-avatar--1" />
                ...
                <button type="button" className="premium2-circle-btn" aria-label="Open Journal Verification" onClick={goToJournalVerify}>
                  <span className="material-symbols-outlined">arrow_forward</span>
                </button>
              </div>
            </article>

            {/* Research Deep Analysis – Module_04 */}
            <article className="premium2-card premium2-card--side premium2-card--compact premium2-card--rda">
              <div className="premium2-card-header">
                <span className="premium2-chip premium2-chip--light">Module_04</span>
                <span className="material-symbols-outlined premium2-card-icon">menu_book</span>
              </div>
              <h3 className="premium2-card-title">Research Deep Analysis</h3>
              <p className="premium2-card-body">
                Deep insights. Comprehensive analysis of your research for publication readiness.
              </p>
              <div className="premium2-card-footer">
                <div className="premium2-avatar-row">
                  <span className="premium2-avatar premium2-avatar--1" />
                ...
                <button type="button" className="premium2-circle-btn" aria-label="Open Research Deep Analysis" onClick={goToResearchDeepAnalysis}>
                  <span className="material-symbols-outlined">arrow_forward</span>
                </button>
              </div>
            </article>

            {/* Main card – PublishReady – Module_01 */}
            <article className="premium2-card premium2-card--main premium2-card--publishready">
              <div className="premium2-card-header">
